...
\draw ($(battery.east) + (0.1,-0.5)$) to [open, v>=$v_{bt}$] ($(battery.east) + (0.1,+0.5)$);
...
\draw ($(fc.east) + (0.1,-0.5)$) to [open, v>=$v_{f\!c}$] ($(fc.east) + (0.1,+0.5)$);
...
\draw ($(el.east) + (0.1,-0.5)$) to [open, v>=$v_{el}$] ($(el.east) + (0.1,+0.5)$);
