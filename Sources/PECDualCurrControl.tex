...
\begin{tikzpicture}[auto, >=latex']
    ...
    \draw [->, fonte] (-1.2,0.25) to node[pos=0, anchor=east] () {$\widehat{v}_{abc}$} (-0.8,0.25); 
    \draw [->, fonte] (-1.2,-0.25) to node[pos=0, anchor=east] () {$\widehat{i}_{abc}$} (-0.8,-0.25); 
    \draw [<-, fonte] (abcdq.south) |- node[pos=1, anchor=east] () {$\theta$} ++(-0.2,-0.5); 
    ...
    \draw [->, fonte] (0.8,1.4) to node[pos=0.5, anchor=south] () {$\widehat{v}_{dq+}$} (1.7,1.4); 
    ...
    \draw [->, fonte] (0.8,-1) to node[pos=0.5, anchor=south] () {$\widehat{v}_{dq-}$} (1.7,-1); 
    ...
    \draw [->, fonte] (3.3,1.2) -- node [pos=0.5, anchor=south] () {$\overset{*}{v}_{dq+}$} (4.2,1.2);
    \node [fonte] at (5,1.2) () {$dq_+\!\mapsto\!abc$};
    \draw [<-, fonte] (Tinvplus.north) |- node[pos=1, anchor=east] () {$\theta$} ++(-0.2,+0.5); 
    \node [sum] at (5,0) (soma) {$\Sigma$};
    \draw [->, fonte] (Tinvplus) -- node [pos=0.5, anchor=east] () {$\overset{*}{v}_{abc+}$} (soma);
    
    \node [draw, rectangle, minimum height=1cm, minimum width=1.6cm] at (5,-1.2) (Tinvminus) {};
    \draw [->, fonte] (3.3,-1.2) -- node [pos=0.5, anchor=south] () {$\overset{*}{v}_{dq-}$} (4.2,-1.2);
    \node [fonte] at (5,-1.2) () {$dq_-\!\mapsto\!abc$};
    \draw [<-, fonte] (Tinvminus.south) |- node[pos=1, anchor=east] () {$\theta$} ++(-0.2,-0.5); 
    \draw [->, fonte] (Tinvminus) -- node [pos=1, anchor=east] () {$\overset{*}{v}_{abc-}$} (soma);
    
    \node[block] at (6.5,0) (pwm) {PWM};
    \draw [->, fonte] (soma) -- node [pos=0.5, anchor=south] () {$\overset{*}{v}_{abc}$} (pwm);
\end{tikzpicture}