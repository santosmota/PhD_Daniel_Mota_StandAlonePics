...
\begin{tikzpicture}[auto, >=latex']
    ...
    \node [fonte] at (2.5,1.4) () {NOT READY};
    \node [fonte] at (2.5,1) () {$i_{dq+}$};
    ...
    \draw [<-] (DQplus.north) |- node [pos=0.7, anchor=east, fonte] () {$\overset{*}{i}_{d+},\overset{*}{i}_{q+}$} ++(-0.2,+0.5);
    \draw [<-] (DQminus.south) |- node [pos=0.7, anchor=east,fonte] () {$\overset{*}{i}_{d-}, \overset{*}{i}_{q-}$} ++(-0.2,-0.7);
