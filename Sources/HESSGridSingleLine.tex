...
\foreach \x/\y/\t/\p in {0/-5/BT/{4.2}, 2.5/-5/FC/{6}, 5/-5/EL/{6}}
{
...
\foreach \x/\y/\t/\p in {2.5/-7.8/Fuel Cell/6, 5/-7.8/Electrolyzer/6}
{
	\draw [thick, shift={(\x,\y)}, rotate=0] (-0.4,0.4) to (0.4,0.4) to (0.4,-0.4) to (-0.4,-0.4) to (-0.4,0.4) to cycle;
...
%\node at (6,0.5) () [anchor=north, fonte] {Constant Impedance Loads};
\node at (7,0.5) () [anchor=north, fonte] {Constant Impedance Loads};
\draw (6,0) to [short] ++(0,-0.4) to [european resistor] ++(0,-1); 
\node at (6.25,-0.65) [fonte, anchor=west] () {Base Load};
\node at (6.25,-0.95) [fonte, anchor=west] () {$\SI{44}{\mega \watt}$};

\draw (8,0) to [short] ++(0,-0.2)
    to [open] ++(0.1,0) 
    to [short] ++(-0.1,-0.2)
    to[european resistor] ++(0,-1); 
\node at (8.25,-0.65) [fonte, anchor=west] () {Step Load};
\node at (8.25,-0.95) [fonte, anchor=west] () {$\SI{4}{\mega \watt}$};
